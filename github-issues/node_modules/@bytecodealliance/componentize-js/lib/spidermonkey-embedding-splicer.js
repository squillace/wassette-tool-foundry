...
function stubWasi(arg0, arg1, arg2, arg3, arg4) {
  var val0 = arg0;
  var len0 = val0.byteLength;
  ...
  for (let i = 0; i < vec2.length; i++) {
    const e = vec2[i];
    const base = result2 + i * 1;var val1 = e;
    let enum1;
    switch (val1) {
      case 'stdio': {
        enum1 = 0;
      ...
      default: {
        ...
        throw new TypeError(`"${val1}" is not one of the cases of feature`);
      }
    }
...
function spliceBindings(arg0, arg1, arg2, arg3, arg4, arg5) {
  var val0 = arg0;
  var len0 = val0.byteLength;
  var ptr0 = realloc1(0, 0, 1, len0 * 1);
  var src0 = new Uint8Array(val0.buffer || val0, val0.byteOffset, len0 * 1);
  ...
  const ret = exports1['local:spidermonkey-embedding-splicer/splicer#splice-bindings'](ptr0, len0, result2, len2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2, variant8_0, variant8_1, variant8_2, arg5 ? 1 : 0);
  let variant23;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var ptr9 = dataView(memory0).getInt32(ret + 4, true);
      ...
      for (let i = 0; i < len21; i++) {
        ...
        result21.push([result19, result20, dataView(memory0).getInt32(base + 16, true) >>> 0]);
      }
      variant23= {
        tag: 'ok',
        val: {
...
const $init = (() => {
  let gen = (function* init () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:filesystem/types@0.2.3': {
        '[method]descriptor.append-via-stream': exports0['18'],
        '[method]descriptor.get-type': exports0['16'],
        '[method]descriptor.metadata-hash': exports0['17'],
        '[method]descriptor.metadata-hash-at': exports0['21'],
        '[method]descriptor.open-at': exports0['26'],
        '[method]descriptor.read-directory': exports0['20'],
        '[method]descriptor.read-via-stream': exports0['22'],
        '[method]descriptor.stat': exports0['24'],
        '[method]descriptor.stat-at': exports0['25'],
        '[method]descriptor.write-via-stream': exports0['23'],
    ...
    postReturn0 = exports1['cabi_post_local:spidermonkey-embedding-splicer/splicer#stub-wasi'];
    postReturn1 = exports1['cabi_post_local:spidermonkey-embedding-splicer/splicer#splice-bindings'];
  })();
...
export { splicer, splicer as 'local:spidermonkey-embedding-splicer/splicer',  }