    ...
    switch (variant28.tag) {
      ...
      case 'jspi': {
        ...
        for (let i = 0; i < vec25.length; i++) {
          const e = vec25[i];
          const base = result25 + i * 8;var ptr24 = utf8Encode(e, realloc1, memory0);
        ...
        for (let i = 0; i < vec27.length; i++) {
          const e = vec27[i];
          const base = result27 + i * 8;var ptr26 = utf8Encode(e, realloc1, memory0);
  ...
  if (variant28 === null || variant28=== undefined) {
    ...
    switch (variant27.tag) {
      ...
      case 'jspi': {
        ...
        var result24 = realloc1(0, 0, 4, len24 * 8);
        for (let i = 0; i < vec24.length; i++) {
          const e = vec24[i];
          const base = result24 + i * 8;var ptr23 = utf8Encode(e, realloc1, memory0);
        ...
        var result26 = realloc1(0, 0, 4, len26 * 8);
        for (let i = 0; i < vec26.length; i++) {
          const e = vec26[i];
          const base = result26 + i * 8;var ptr25 = utf8Encode(e, realloc1, memory0);
