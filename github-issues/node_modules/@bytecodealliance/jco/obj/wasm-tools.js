...
function metadataShow(arg0) {
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      var base10 = dataView(memory0).getInt32(ret + 4, true);
      var result10 = [];
      for (let i = 0; i < len10; i++) {
        ...
        switch (dataView(memory0).getUint8(base + 8, true)) {
          ...
          case 1: {
            var ptr2 = dataView(memory0).getInt32(base + 12, true);
            var len2 = dataView(memory0).getInt32(base + 16, true);
            var result2 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr2, len2));
            variant3 = result2;
            break;
          }
        ...
        var len9 = dataView(memory0).getInt32(base + 40, true);
        var base9 = dataView(memory0).getInt32(base + 36, true);
        var result9 = [];
        for (let i = 0; i < len9; i++) {
          ...
          var base8 = dataView(memory0).getInt32(base + 8, true);
          var result8 = [];
